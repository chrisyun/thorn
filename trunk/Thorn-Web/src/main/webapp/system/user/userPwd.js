...
var ChangeMyPwd = sys.basePath + "user/changePwd.jmt";
var pwdUrl;

var UserPwd = function(type) {
	if (type == "my") {
		pwdUrl = ChangeMyPwd;
	} else {
		pwdUrl = ChangePwd;
	...
	this.form.addItem(getPanelItem(
			getRPwdTxt("newrPwd", "重复密码", 200, "newPwd"), 1.0, true));
	...
	this.win = new OpenWindow({
				width : 340,
				height : 150
			}, this.form.getFormPanel(), changePwdHandler);
