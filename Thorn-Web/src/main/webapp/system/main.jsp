	...
	<body>
		<div id="header">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
			   		<td width="664"><img src="<%=basePath %>/resources/images/local/title-1.jpg" width="664" height="67" /></td>
			    	<td background="<%=basePath %>/resources/images/local/title-2.jpg">&nbsp;</td>
			    	<td width="372"><img src="<%=basePath %>/resources/local/images/title-3.jpg" width="372" height="67" /></td>
			  	</tr>
			</table>
		</div>
